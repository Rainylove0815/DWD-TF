...
parser.add_argument('--root_path', type=str, default='D:\\HaotianZhang\\ALHVR.-main\\ALHVR.-main\\train_ALHVR\\data\\ACDC', help='Name of Experiment')
parser.add_argument('--exp', type=str, default='ALHVR_without_SPF', help='experiment_name')
...
def Inference(FLAGS):
    ...
    snapshot_path = "D:\\HaotianZhang\\ALHVR.-main\\ALHVR.-main\\train_ALHVR\\code\\model\\ACDC_{}_{}_labeled\\unet_fea_aux\\".format( FLAGS.exp, FLAGS.labelnum)
    test_save_path = "D:\\HaotianZhang\\ALHVR.-main\\ALHVR.-main\\train_ALHVR\\code\\model\\ACDC_{}_{}_labeled\\{}_prediction\\".format(FLAGS.exp, FLAGS.labelnum, FLAGS.model)
    ...
    save_model_path = os.path.join(snapshot_path, 'unet_fea_aux_best_model1.pth')
