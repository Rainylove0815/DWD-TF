...
parser.add_argument('--root_path', type=str,
                    default='D:\\HaotianZhang\\ALHVR.-main\\ALHVR.-main\\train_ALHVR\\data\\Prostate',
...
def Inference(FLAGS):
    ...
    snapshot_path = "D:\\HaotianZhang\\ALHVR.-main\\ALHVR.-main\\train_ALHVR\\code\\model\\Prostate_{}_{}_labeled\\unet_fea_aux\\".format(
        FLAGS.exp, FLAGS.labelnum)
    test_save_path = "D:\\HaotianZhang\\ALHVR.-main\\ALHVR.-main\\train_ALHVR\\code\\model\\Prostate_{}_{}_labeled\\{}_prediction\\".format(
    ...
    save_model_path = os.path.join(snapshot_path, 'unet_fea_aux_best_model2.pth')
