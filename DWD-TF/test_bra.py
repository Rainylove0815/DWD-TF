...
parser.add_argument('--exp', type=str,
                    default='ALHVR_without_SPF', help='experiment_name')
...
def Inference(FLAGS):
    snapshot_path = "D:\\HaotianZhang\\ALHVR.-main\\ALHVR.-main\\train_ALHVR\\code\\model\\Brats_{}_25_labeled\\vnet_fea_aux\\".format(FLAGS.exp)
    num_classes = 2
    test_save_path = "D:\\HaotianZhang\\ALHVR.-main\\ALHVR.-main\\train_ALHVR\\code\\model\\Brats_{}_25_labeled\\Prediction".format(FLAGS.exp)
    ...
    save_mode_path = os.path.join(
           snapshot_path, 'vnet_fea_aux_best_model2.pth')
