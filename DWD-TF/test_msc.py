...
from dataloaders.dataset_msc import MRSEG19Normalization

from models.net_factory import net_factory

parser = argparse.ArgumentParser()
parser.add_argument('--root_path', type=str,
                    default='D:\\HaotianZhang\\ALHVR.-main\\ALHVR.-main\\train_ALHVR\\data\\msc', help='Name of Experiment')
parser.add_argument('--model', type=str,
                    default='unet_fea_aux', help='model_name')
parser.add_argument('--num_classes', type=int,  default=4,
                    help='output channel of network')
parser.add_argument('--labeled_num', type=int, default=7,
                    help='labeled data')
# parser.add_argument('--ckpt' , type=str, default='./logs/msc02/diffrect_7_labeled/unet/unet_best_model.pth',
#                     help='checkpoint_name')
parser.add_argument('--ckpt' , type=str, default='D:\\HaotianZhang\\ALHVR.-main\\ALHVR.-main\\train_ALHVR\\code\\model\\mscmrseg19_ALHVR_without_SPF_labeled\\unet_fea_aux\\unet_fea_aux_best_model2.pth',
                    help='checkpoint_name')
...
def Inference(FLAGS, list=None):
    ...
    test_save_path = os.path.join(ckpt_dir, 'predictions')
    ...
    second_total = 0.0
    third_total = 0.0
    test_save_path = "D:\\HaotianZhang\\ALHVR.-main\\ALHVR.-main\\train_ALHVR\\code\\model\\mscmrseg19_ALHVR_without_SPF_labeled\\unet_fea_aux_prediction\\"
