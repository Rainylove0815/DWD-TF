...
parser.add_argument('--root_path', type=str, default='D:\\HaotianZhang\\ALHVR.-main\\ALHVR.-main\\train_ALHVR\\data\\Prostate', help='Name of Experiment')
...
# 新增调优参数
parser.add_argument('--ua_warmup', type=int, default=8000, help='UA-DTCT warmup iterations')
parser.add_argument('--min_weight', type=float, default=0.4, help='minimum weight for UA-DTCT')
parser.add_argument('--max_weight', type=float, default=0.6, help='maximum weight for UA-DTCT')
